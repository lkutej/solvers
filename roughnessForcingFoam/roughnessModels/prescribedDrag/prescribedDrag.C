...
{
    defineTypeNameAndDebug(prescribedDrag, 0);
    addToRunTimeSelectionTable(roughnessModel, prescribedDrag, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

prescribedDrag::prescribedDrag
(
...
tmp<fvVectorMatrix> prescribedDrag::force(volVectorField& U) const
{
...
void prescribedDrag::updateForce(volVectorField& U)
{
    dimensionedScalar dimFix("dimFix", dimless/dimLength, 1.0);
