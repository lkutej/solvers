...
namespace pPFPorosityModels
{
    ...
    addToRunTimeSelectionTable(pPFPorosityModel, prescribedDragHet, dictionary);
...
:
    ...
    Cx_("Cx", dimless, pPFPorosityModelDict.lookup("Cx")),
    Cy_("Cy", dimless, pPFPorosityModelDict.lookup("Cy")),
    Cz_("Cz", dimless, pPFPorosityModelDict.lookup("Cz"))

{
    List<scalar> yD(pPFPorosityModelDict.lookup("y"));
    List<scalar> dragCoeffD(pPFPorosityModelDict.lookup("dragCoeff"));
...
tmp<fvVectorMatrix> prescribedDragHet::force(volVectorField& U)
{
